...
<Frame>
  <img src="/images/actions/sidebar-actions.png" alt="The Building Blocks sidebar group with Actions highlighted" />
</Frame>

The page is split into two parts: your team's custom actions on top, and the read-only built-in actions below.

<Frame>
  <img src="/images/actions/library.png" alt="The Actions library: a Published action, a Draft action, and the building blocks" />
</Frame>
...
<Frame>
  <img src="/images/actions/new-action-dialog.png" alt="The New action dialog with the 'What should it do?' choices" />
</Frame>

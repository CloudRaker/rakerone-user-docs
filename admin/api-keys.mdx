...
<Frame>
  <img src="/images/admin/api-keys-table.png" alt="The API keys table with name, permissions, last used, and created columns" />
</Frame>
...
<Frame>
  <img src="/images/admin/api-key-create-dialog.png" alt="The Create API key dialog with name, permissions, and impersonation" />
</Frame>
...
<Frame>
  <img src="/images/admin/api-key-copy.png" alt="The Copy your API key screen shown once after creation" />
</Frame>
...
<Frame>
  <img src="/images/admin/api-key-revoke.png" alt="The Revoke this API key confirmation dialog" />
</Frame>

...
{/* TODO: Screenshot [Non Automatable: conceptual diagram — author as an illustration] — A simple labeled diagram of Organization → Building Blocks + Projects → Runs → Tasks → Records */}
...
<Frame>
  <img src="/images/get-started/sidebar-full.png" alt="The full RakerOne sidebar with every navigation group" />
</Frame>

...
{/* TODO: Screenshot — A simple labeled diagram: Organization → Building Blocks + Projects → Runs → Tasks → Records */}
...
{/* TODO: Screenshot — A run workspace showing the task rail with a spread of task-type chips and status badges */}

...
{/* TODO: Screenshot — The Add task dropdown open in the playbook builder, showing the type list: Form, File upload, Document, Action, AI task, Form fill */}
...
{/* TODO: Screenshot — A Document task mid-run at Reading document with the "Florent is reading documents and preparing results for review" message */}
...
{/* TODO: Screenshot — An AI task running, showing "Florent is working on this task" */}

...
{/* TODO: Screenshot — The New playbook dialog with Name, Identifier, Run number prefix, and Description filled in */}
...
{/* TODO: Screenshot — Tasks tab with the Task flow map at top and the Task details list below, showing type badges, an Approval chip, and "Waits for" chips */}
...
{/* TODO: Screenshot — Settings tab showing the Numbering card with its live preview and the Florent card with its switches */}

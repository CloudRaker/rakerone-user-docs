...
<Steps>
  ...
  <Step title="Choose a starting point">
    ...
    {/* TODO: Screenshot — Step 1 card grid showing the "Blank project" card alongside a couple of template cards */}
  ...
  <Step title="Fill in the details">
    ...
    {/* TODO: Screenshot — Step 2 form with Details (name, project number hint, icon, description) and the Access section */}
  </Step>
...
{/* TODO: Screenshot — Settings tab showing Project details, Access, the Close-this-project section, and the Summary card */}
